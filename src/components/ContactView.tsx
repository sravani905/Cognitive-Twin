        ...
        <div className="flex-1">
          <AnimatePresence mode="wait">
            {activeTab === 'form' && (
              ...
              >
                <div className="text-center max-w-2xl mx-auto space-y-4 py-4">
                  <span className="text-[#8A2BE2] font-bold text-xs uppercase tracking-[0.3em] bg-[#8A2BE2]/8 border border-[#8A2BE2]/18 px-4.5 py-1.5 rounded-full inline-block">Direct Inbox</span>
                ...
                <div className="grid md:grid-cols-5 gap-8 max-w-3xl mx-auto items-start">
                  ...
                  <div className="md:col-span-2 space-y-4 font-sans text-left">
                    ...
                    <div className="p-5 bg-white/70 border border-purple-100 rounded-3xl flex flex-col space-y-3 shadow-sm">
                      ...
                      <a 
                        ...
                        className="text-[11px] text-[#8A2BE2] font-mono hover:underline flex items-center gap-1 leading-normal"
                      >
                  ...
                  <div className="md:col-span-3 bg-white border border-purple-150 p-6 md:p-8 rounded-[2.5rem] shadow-xl shadow-[#8A2BE2]/5 text-left">
                    <AnimatePresence mode="wait">
                      {!sentStatus ? (
                        <motion.form 
                          key="form-fields"
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <input 
                              ...
                              className="w-full px-4 py-2.5 rounded-xl border border-purple-100 text-xs bg-slate-50 focus:bg-white focus:ring-1 focus:ring-[#8A2BE2] outline-none text-slate-800"
                            />
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <textarea 
                              ...
                              className="w-full px-4 py-2.5 rounded-xl border border-purple-100 text-xs bg-slate-50 focus:bg-white focus:ring-1 focus:ring-[#8A2BE2] outline-none text-slate-800 resize-none"
                            ></textarea>
                          </div>

                          <button 
                            type="submit"
                            className="w-full py-3 bg-gradient-to-r from-[#8A2BE2] to-[#9979f4] text-white text-xs font-bold uppercase tracking-wider rounded-xl hover:brightness-105 active:scale-98 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md"
                          >
                        ...
                        >
                          ...
                          <button
                            onClick={resetForm}
                            className="px-4 py-2 border border-purple-100 rounded-full text-xs font-bold uppercase tracking-wider text-[#8A2BE2] hover:bg-slate-50 transition-all cursor-pointer"
                          >
            ...
            {activeTab === 'team' && (
              ...
              >
                <div className="text-center max-w-2xl mx-auto space-y-4 py-4">
                  <span className="text-[#8A2BE2] font-bold text-xs uppercase tracking-[0.3em] bg-[#8A2BE2]/8 border border-[#8A2BE2]/18 px-4.5 py-1.5 rounded-full inline-block">The Creators</span>
                ...
                {/* Faculty Guides card */}
                <div className="bg-gradient-to-r from-violet-50/50 via-[#9979f4]/5 to-transparent border border-[#8A2BE2]/20 p-6 rounded-3xl max-w-3xl mx-auto flex flex-col md:flex-row gap-5 items-center justify-between text-left">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-2xl bg-white border border-[#8A2BE2]/20 flex items-center justify-center text-[#8A2BE2] shadow-sm shrink-0">
